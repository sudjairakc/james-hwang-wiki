...
const th: typeof en = {
  ui: {
    ...
    revenueNote: 'สัดส่วนทัวร์ด้านบนคือ mix รายปีแบบ steady-state ไม่ใช่ตัวเลขจริงของปีใดปีหนึ่ง — มันแกว่งแรงตามปฏิทินทัวร์ ตลอดสองทัวร์ที่ James เคยเล่น ยอดขายตั๋วรวมอยู่ที่ $309M ($235M จาก PULSE, $74M จาก DECADE) ซึ่งตกอยู่ในปีที่แต่ละทัวร์เดินสายจริงเกือบทั้งหมด ไม่ได้กระจายเท่ากันทุกปี',
  ...
  brand: {
    ...
    tagline: 'One Vision. Many Horizons.',
    platform: 'Framing the Horizon',
    positioning: 'entertainment house ที่นำโดย creator สร้างขึ้นรอบงานของ James Hwang ล้วนๆ — เปลี่ยนวิสัยทัศน์ศิลปินหนึ่งเดียวให้เป็นเพลง การแสดง เรื่องราว และภาพยนตร์ งาน creative และ production ทำในบริษัท และโดยเจตนาของ founder บริษัทไม่รับดูแลศิลปินคนอื่น',
    image: 'jh_company_ci.png',
    imageCaption: 'บอร์ดอัตลักษณ์องค์กร JH Company — ระบบโลโก้ monogram, มาร์ก sub-brand, ชุดสี, typography และตัวอย่างการใช้งานจริง พัฒนาภายใต้ creative platform "Framing the Horizon"',
    pillars: [
      { name: 'Authorship', desc: 'ทุกผลงานมีลายมือและมุมมองของ James — ไม่ใช่งาน creative-by-committee' },
      { name: 'Expansion', desc: 'วิสัยทัศน์เดียวขยายข้ามรูปแบบ — เสียง เรื่องราว จอ เวที — ไม่ใช่ขยายเป็น roster ศิลปิน' },
      { name: 'Craft', desc: 'ให้ความสำคัญกับรายละเอียด คุณภาพ และความเนี้ยบ มากกว่าปริมาณงาน' },
      { name: 'Integration', desc: 'creative และ production อยู่ใต้ชายคาเดียว วิสัยทัศน์กับ execution จึงไปด้วยกัน' },
