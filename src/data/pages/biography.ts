...
const en = {
  ...
  quickFacts: [
    ...
    { label: 'Stage Name', val: 'GONUNMA (고눈마) — producer credit (2016–present) · formerly public artist name (2016–2023)' },
    { label: 'Height', val: '183 cm' },
  ...
  chapters: [
    ...
    },
    {
      ...
      body: [
        ...
        "In the months surrounding the Grammy campaign, JH Company began a quiet but deliberate shift in how James was positioned publicly. US press, late-night appearances, and official releases increasingly used \"James Hwang\" as the sole public-facing name. GONUNMA — which had originated from his 2016 King of Mask Singer nickname and had been his primary artist brand through 2023 — was retained exclusively as a production alias on album credits. The decision reflected a practical reality: in the American market, GONUNMA required explanation and carried no recognition, while \"James Hwang\" was already the name audiences knew from the Shang-Chi franchise. JH Company noted that SM Entertainment had no legal claim to the GONUNMA name — the name predated its use on SM-released material and had originated from a public broadcast program — but the consolidation was driven by clarity, not dispute.",
      ],
    },
    {
      id: '07',
      period: '2025–2026',
      title: 'POPSTAR Era — SOUR|HONEY, Shang-Chi II, and the Return',
      body: [
...
const th: typeof en = {
  ...
  quickFacts: [
    ...
    { label: 'ชื่อในวงการ', val: 'GONUNMA (고눈마) — เครดิต producer (2016–ปัจจุบัน) · เดิมเคยเป็นชื่อศิลปินสาธารณะ (2016–2023)' },
    { label: 'ส่วนสูง', val: '183 cm' },
  ...
  chapters: [
    ...
    },
    {
      ...
      body: [
        ...
        'ในช่วงหลายเดือนรอบแคมเปญ Grammy JH Company เริ่มปรับตำแหน่งการรับรู้สาธารณะของ James อย่างเงียบๆ แต่ตั้งใจ สื่อสหรัฐฯ รายการทอล์กโชว์ดึกๆ และผลงานที่ปล่อยอย่างเป็นทางการเริ่มใช้ชื่อ "James Hwang" เป็นชื่อสาธารณะเพียงชื่อเดียวมากขึ้นเรื่อยๆ GONUNMA — ที่มีที่มาจากชื่อเล่นในรายการ King of Mask Singer ปี 2016 และเคยเป็นแบรนด์ศิลปินหลักของเขามาจนถึงปี 2023 — ถูกเก็บไว้ใช้เฉพาะเป็นนามแฝงด้าน production บนเครดิตอัลบั้มเท่านั้น การตัดสินใจนี้สะท้อนความจริงเชิงปฏิบัติ: ในตลาดอเมริกา GONUNMA ต้องอธิบายเพิ่มและไม่มีใครรู้จัก ในขณะที่ "James Hwang" เป็นชื่อที่ผู้ชมรู้จักอยู่แล้วจากแฟรนไชส์ Shang-Chi JH Company ระบุว่า SM Entertainment ไม่มีสิทธิ์ทางกฎหมายเหนือชื่อ GONUNMA — เพราะชื่อนี้มีมาก่อนที่จะถูกใช้ในผลงานที่ปล่อยผ่าน SM และมีที่มาจากรายการโทรทัศน์สาธารณะ — แต่การรวมชื่อครั้งนี้เกิดจากความต้องการความชัดเจน ไม่ใช่ข้อพิพาท',
      ],
    },
    {
      id: '07',
      period: '2025–2026',
      title: 'ยุค POPSTAR — SOUR|HONEY, Shang-Chi II และการกลับมา',
      body: [
