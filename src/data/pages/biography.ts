  ...
  chapters: [
    {
      ...
      body: [
        'James Hwang เกิดวันที่ 22 มิถุนายน 1998 ที่กรุงเทพฯ พ่อเป็นนักธุรกิจไทย-จีน แม่เป็นนักเขียนและกวีชาวเกาหลี ระหว่างบ้านพ่อ ญาติฝั่งแม่ และโรงเรียนอินเตอร์ เขาได้สี่ภาษาติดตัวมาตั้งแต่เด็ก — ไทย จีน อังกฤษ เกาหลี พ่อแม่แยกทางกันช่วงปี 2008–2009 ตอนเขาอยู่ประถมปลาย เขาอยู่กรุงเทพฯ กับพ่อมาตลอดช่วงเรียน แล้วย้ายไปอยู่กับแม่ที่โซลเมื่อเริ่มฝึกกับ SM จริงจังปลายปี 2013',
        ...
        'อีกทางเขาเล่นศิลปะการต่อสู้และท่าผาดโผน — tricking, flips และเต้น hip-hop freestyle — ซึ่งเป็นไม้ตายในรอบออดิชันเทรนนี และเป็นเหตุผลที่ทำให้เขาได้บทใน MCU',
      ],
    },
    {
      id: '02',
    ...
    },
    {
      ...
      body: [
        ...
        'ตั้งแต่เป็นอิสระในปี 2023 JH Company ดัน "James Hwang" ขึ้นเป็นชื่อหลักที่ใช้กับสาธารณะ ทั้งสื่อสหรัฐฯ รายการทอล์กโชว์ดึก และผลงานที่ปล่อยอย่างเป็นทางการ และชัดขึ้นเรื่อยๆ จนถึงแคมเปญ Grammy ปี 2025 ส่วน GONUNMA ที่มาจากชื่อเล่นในรายการ King of Mask Singer ปี 2016 ถูกเก็บไว้เป็นเครดิตโปรดิวเซอร์กับคนแต่งเพลง และเป็นชื่อบัญชี SNS (@gonunma) เหตุผลตรงไปตรงมา: ในตลาดอเมริกา GONUNMA ต้องอธิบายและไม่มีใครรู้จัก ขณะที่ "James Hwang" เป็นชื่อที่คนดูจำได้จากแฟรนไชส์ Shang-Chi อยู่แล้ว เรื่องสิทธิ์จบไปก่อนหน้านั้น — SM เคยอ้างสิทธิ์ในชื่อนี้ระหว่างข้อพิพาท แล้วถอนข้ออ้างใน settlement ปี 2023 เพราะชื่อมาจากรายการโทรทัศน์สาธารณะและมีมาก่อนที่ SM จะเอาไปใช้ การรวมชื่อในปี 2025 จึงเป็นเรื่องของความชัดเจนล้วนๆ',
      ],
    },
    {
      id: '07',
      ...
      body: [
        'เดือนธันวาคม 2024 James กลับไปร่วมกิจกรรม NCT 127 ในฐานะ external artist ซึ่งแทบไม่มีใครทำได้มาก่อนใน K-pop เพราะคนที่ออกจากค่ายหลังฟ้องร้องกันมักไม่ได้กลับมาร่วมงานกับวงอีก SM ยอมเพราะตอนนั้นเขากลายเป็นชื่อระดับโลกที่วงสร้างเองไม่ได้ การเสียเขาไปถาวรจึงแพงกว่าการแบ่งอำนาจควบคุม เงื่อนไขคือ James ถือ JH Company และ catalog หลังปี 2023 ไว้เต็มร้อย เลือกเองได้ว่าจะร่วมงานวันไหนหรือผลงานไหน และไม่ต้องเซ็นสัญญาผูกขาดใหม่ ข้อตกลงนี้คุมทุกอย่างที่ตามมา ตั้งแต่การพักวงตลอดปี 2025 จนถึงการกลับมาร่วมงานครบรอบ 10 ปีเต็มตัวช่วงมิถุนายน–กรกฎาคม 2026 ในทุกวันที่จัดนอกประเทศไทย',
