  ...
  chapters: [
    {
      ...
      body: [
        'James Hwang เกิดวันที่ June 22, 1998 ที่ Bangkok, Thailand พ่อของเขาเป็นนักธุรกิจไทย-จีน ส่วนแม่เป็นนักเขียนและกวีชาวเกาหลี ระหว่างครอบครัวฝั่งพ่อที่เป็นไทย-จีน ญาติฝั่งแม่ที่เป็นเกาหลี และโรงเรียนสายอินเตอร์ที่กรุงเทพฯ James เติบโตมาพร้อมสี่ภาษาตั้งแต่เกิด — ไทย จีน อังกฤษ และเกาหลี พ่อแม่ของเขาแยกทางกันในปี 2008–2009 ตอนที่เขาอยู่ชั้นประถมปลาย เขาอยู่ที่กรุงเทพฯ กับพ่อเป็นหลักตลอดช่วงที่เหลือของการเรียน แล้วย้ายไปอยู่กับแม่ที่โซลเป็นหลักตอนเริ่มฝึกกับ SM อย่างจริงจังช่วงปลายปี 2013',
    ...
    },
    {
      ...
      body: [
        ...
        'หลังออดิชัน ชื่อของเขาแพร่ในคอมมูนิตี้แฟนออนไลน์ในฐานะหนึ่งใน "เด็กไทยสองคนที่ผ่าน SM" — ถูกบรรยายว่าเป็น "คนตัวสูงที่เล่น flips" วันที่ December 16, 2013 เขาถูกแนะนำตัวอย่างเป็นทางการในฐานะสมาชิก SM Rookies เทรนนีก่อนเดบิวต์ในสาย performance และ vocal และถูกมองว่าเป็นหนึ่งใน prospect ที่โดดเด่นที่สุดของรุ่นทันที การย้ายไปโซลครั้งนี้ยังแปลว่าเขาได้อยู่กับแม่แบบเต็มเวลาเป็นครั้งแรกนับตั้งแต่พ่อแม่แยกทางกัน',
    ...
    },
    {
      ...
      body: [
        ...
        'ต้นเดือน February 2023 James เริ่มปรึกษาทีมกฎหมายเรื่องโครงสร้างสัญญา creative control และการปฏิบัติที่ไม่เป็นธรรม ปลายเดือนกุมภาพันธ์เขายื่นคำร้อง injunction ระงับข้อผูกพันตามสัญญาและเปิดการเจรจาอย่างเป็นทางการ กลางเดือนมีนาคม SM ฟ้องกลับโดยอ้างความเสียหายต่อชื่อเสียง และข้อพิพาทถูกเปิดเผยต่อสาธารณะผ่าน Dispatch ที่เผยแพร่บางส่วนของบันทึกเสียงการประชุมภายใน เขาเข้าร่วมงาน 95th Academy Awards วันที่ March 12 — ปีที่ Everything Everywhere All at Once กวาดรางวัลสายหลักไปเกือบหมด — ปรากฏตัวร่วมกับทีมนักแสดงในงานหลังงานประกาศผล และใช้เวทีนี้ตอกย้ำสถานะ global-artist ของตัวเองระหว่างที่ข้อพิพาทยังดำเนินอยู่',
        'การไกล่เกลี่ยรอบสุดท้ายสำเร็จช่วงกลาง–ปลายเดือน April 2023 และเซ็น settlement วันที่ 27 April James ยุติสัญญากับ SM แบบตกลงร่วมกันทั้งสองฝ่าย ทั้งสองฝ่ายถอนคำร้องทางกฎหมาย และมีข้อตกลงแบบไม่เป็นทางการเรื่อง non-blacklisting เกิดขึ้น วันที่ April 30, 2023 เขาก่อตั้ง JH Company และเซ็นสัญญาพาร์ตเนอร์ด้าน distribution กับ Warner Music Korea งานแต่งเพลงต้นฉบับทั้งหมดที่ทำขึ้นระหว่างช่วงสัญญาถูกยืนยันให้เป็น intellectual property ของเขาเอง — รากฐานของ catalog โซโล่ที่ตามมา ส่วน master recordings ที่ทำไว้ใต้ SM ยังอยู่กับ SM ซึ่งเป็นเหตุผลที่อัลบั้ม DECADE ในเวลาต่อมาใช้ solo version ที่อัดใหม่ของเพลงเหล่านั้น',
    ...
    },
    {
      ...
      body: [
        ...
        'ตั้งแต่เป็นอิสระในปี 2023 JH Company วางชื่อ "James Hwang" เป็นชื่อโปรโมทสาธารณะหลัก — สื่อสหรัฐฯ รายการทอล์กโชว์ดึกๆ และผลงานที่ปล่อยอย่างเป็นทางการใช้เป็นชื่อหลัก และการปรับนี้ชัดเจนขึ้นเรื่อยๆ จนถึงแคมเปญ Grammy ปี 2025 GONUNMA — ที่มีที่มาจากชื่อเล่นในรายการ King of Mask Singer ปี 2016 และเป็นที่รู้จักในวงกว้างตั้งแต่ตอนนั้น แม้ SM จะไม่ได้ผลักดันอย่างเป็นทางการ — ถูกเก็บไว้เป็นเครดิต production/แต่งเพลง และเป็นชื่อแอคเคานต์ SNS (@gonunma) การตัดสินใจนี้สะท้อนความจริงเชิงปฏิบัติ: ในตลาดอเมริกา GONUNMA ต้องอธิบายเพิ่มและไม่มีใครรู้จัก ในขณะที่ "James Hwang" เป็นชื่อที่ผู้ชมรู้จักอยู่แล้วจากแฟรนไชส์ Shang-Chi SM เคยอ้างสิทธิ์ในชื่อ GONUNMA ระหว่างข้อพิพาท และถอนข้ออ้างนั้นเป็นส่วนหนึ่งของ settlement ปี 2023 ซึ่งยืนยันว่าสิทธิ์เป็นของ James ทั้งหมด — เพราะชื่อนี้มีมาก่อนที่จะถูกใช้ในผลงานที่ปล่อยผ่าน SM และมีที่มาจากรายการโทรทัศน์สาธารณะ เมื่อความเป็นเจ้าของไม่เป็นประเด็นแล้ว การรวมชื่อในปี 2025 จึงเกิดจากความต้องการความชัดเจน ไม่ใช่ข้อพิพาทที่ยังค้างอยู่',
      ],
    },
    {
      id: '07',
      ...
      body: [
        'เดือนธันวาคม 2024 James กลับมาร่วมกิจกรรม NCT 127 ในฐานะ external artist ภายใต้ข้อตกลงที่แทบไม่มี precedent มาก่อนในวงการ K-pop เพราะ artist ที่ออกจากค่ายหลังข้อพิพาททางกฎหมายเต็มรูปแบบมักไม่กลับมาร่วมกิจกรรมกลุ่มอีกเลย SM ยอมเพราะการเสียเขาไปแบบถาวร ตอนนี้ในฐานะชื่อระดับโลกที่วงเองสร้างไม่ได้แล้ว สร้างความเสียหายมากกว่าการยอมแบ่งอำนาจควบคุมบางส่วน เงื่อนไขที่ได้คือ James คุมความเป็นเจ้าของ JH Company และ catalog หลังปี 2023 ไว้เต็มร้อย เลือกเองได้ว่าจะร่วมวันไหนหรือผลงานไหน และไม่ต้องเซ็นสัญญาผูกขาดใหม่ ข้อตกลงนี้กำกับทุกอย่างที่ตามมา: ช่วง hiatus ตลอดปี 2025 แล้วกลับมาเข้าร่วมเต็มตัวในงานครบรอบ 10 ปีของวงช่วง June–July 2026 ในทุกวันที่จัดนอก Thailand',
        ...
        'เดือน September 2026 มีสองผลงานใหญ่มาบรรจบกัน: DECADE — อัลบั้ม anthology ชุดแรกของเขา ฉลองครบสิบปีนับจากเดบิวต์กับ NCT 127 พร้อมเพลงใหม่สี่เพลง — และ Shang-Chi and the Last of the Ten Rings กำกับโดย Destin Daniel Cretton และร่วมเขียนบทโดย James ปิดไตรภาคอย่างสมบูรณ์ ในเดือนเดียวกัน ความสัมพันธ์ของเขากับนักแสดงร่วม Ashley Liao ก็ถูกยืนยันต่อสาธารณะผ่านแถลงการณ์ร่วม',
