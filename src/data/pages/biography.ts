  ...
  chapters: [
    ...
    },
    {
      ...
      body: [
        ...
        "James had returned to NCT 127 as an external artist back in December 2024, under an arrangement without real precedent in K-pop — where artists who fully depart an agency after a legal dispute don't come back to group activity. SM agreed because losing him permanently, now that he carried a global name the group could no longer generate on its own, cost more than sharing control. The terms gave James full ownership of JH Company and his post-2023 catalog, his own choice of which dates and releases to join, and no renewed exclusive contract. After his 2025 hiatus, it was under that same agreement that, in June–July 2026, James resumed full activity with NCT 127 for the group's 10th anniversary, participating across all dates outside Thailand.",
  ...
  chapters: [
    ...
    },
    {
      ...
      body: [
        ...
        'James กลับมาร่วมกิจกรรม NCT 127 ในฐานะ external artist ตั้งแต่เดือนธันวาคม 2024 ภายใต้ข้อตกลงที่แทบไม่มี precedent มาก่อนในวงการ K-pop เพราะ artist ที่ออกจากค่ายหลังข้อพิพาททางกฎหมายเต็มรูปแบบมักไม่กลับมาร่วมกิจกรรมกลุ่มอีกเลย SM ยอมเพราะการเสียเขาไปแบบถาวร ตอนนี้ในฐานะชื่อระดับโลกที่วงเองสร้างไม่ได้แล้ว สร้างความเสียหายมากกว่าการยอมแบ่งอำนาจควบคุมบางส่วน เงื่อนไขที่ได้คือ James คุมความเป็นเจ้าของ JH Company และ catalog หลังปี 2023 ไว้เต็มร้อย เลือกเองได้ว่าจะร่วมวันไหนหรือผลงานไหน และไม่ต้องเซ็นสัญญาผูกขาดใหม่ หลังช่วง hiatus ปี 2025 ภายใต้ข้อตกลงเดียวกันนี้เอง James กลับมา active เต็มตัวกับ NCT 127 ในช่วง June–July 2026 สำหรับงานฉลองครบรอบ 10 ปี โดยเข้าร่วมเต็มที่ในทุกวันที่จัดนอก Thailand',
