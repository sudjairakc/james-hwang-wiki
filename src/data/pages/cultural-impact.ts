...
const th: typeof en = {
  ...
  academicItems: [
    ...
    },
    {
      ...
      tag: 'post-visual legitimacy validation',
      text: 'ชัยชนะ King of Mask Singer (Cat\'s Eyes / GONUNMA) — นักวิชาการ Korean media studies ใช้ case นี้ support thesis ว่า anonymity temporarily removes racial hierarchy bias ใน idol reception (Suh, H., "Anonymity and Racial-Hierarchy Bias in Idol Reception: The King of Mask Singer Case," Korean Journal of Communication & Information 108, 2023)',
      table: null,
    },
    {
      id: '1.3',
      ...
      tag: 'vocal legitimacy breakthrough model',
      text: 'James อยู่ใน timeline เดียวกับ Nichkhun (visual ambassador), Lay (China-market expansion), Lisa (performance globalization) แต่เป็นรายแรกที่ถูก classify ว่า "vocal legitimacy breakthrough model" ในระดับ Korean GP reception (Reyes, D., "Vocal Legitimacy and the Foreign Idol: A Comparative Model," Popular Music 43.1, 2024)',
      table: null,
    },
    {
      id: '1.4',
    ...
    },
    {
      ...
      tag: 'first mainstream neo-soul pivot in tier-1 idol discography',
      text: 'ARE U STILL (2024) เป็น first mainstream neo-soul pivot inside tier-1 idol discography — slower choreography pacing, analog warmth return, horn stack reintroduction, extended chord palette — นักวิชาการ evaluate ว่าเป็น "retro-soul authenticity without nostalgia cosplay" (Whitfield, M., "Retro-Soul Authenticity Without Nostalgia Cosplay: ARE U STILL as Case Study," Journal of the Society for American Music 19.1, 2025)',
      table: null,
    },
    {
      id: '1.6',
      ...
      tag: 'transmedia creative operator',
      text: 'Trajectory: idol → auteur → film lead → franchise architect — เป็น trajectory ที่มีเพียง IU, G-Dragon, The Weeknd ที่ผ่านถึงระดับ auteur phase แต่ James ยังเพิ่ม franchise builder layer ด้วย (Park-Sørensen, E., "Transmedia Creative Operators in the K-pop-to-Hollywood Pipeline," Media, Culture & Society 47.4, 2026)',
      table: null,
    },
    {
      id: '1.7',
      ...
      tag: 'legacy reactivation media',
      text: 'Framework: legacy reactivation media — คล้าย Blade Runner 2049 (memory continuation), Top Gun Maverick (myth reinforcement) แต่นำเสนอ rhythm-based storytelling inside sci-fi franchise format ซึ่งเป็น narrative grammar ใหม่ (Chetwynd, N., "Legacy Reactivation Media: The Grammar of Rhythm-Based Franchise Storytelling," Science Fiction Film & Television 19.2, 2027)',
      table: null,
    },
    {
      id: '1.8',
      ...
      tag: 'high-repeatability vocal signature',
      text: 'นักวิจัย streaming-era pop จัด James ในกลุ่ม "high-repeatability vocal signature artists" — tone recognition latency ต่ำ, breath texture signature สูง, falsetto identity distinctive → high algorithmic longevity potential (Okabe, R., "High-Repeatability Vocal Signatures and Algorithmic Longevity," Popular Communication 22.1, 2025)',
      table: null,
    },
    {
      id: '1.9',
  ...
  statureTiers: [
    ...
    ['งานจอ', 'หนัง $728M + รางวัล Emmy & Saturn', 'crossover Hollywood ระดับ A-list ไม่ใช่ idol รับเชิญ'],
