...
const en = {
  ...
  universeRows: [
    ...
    { item: 'Antagonist', val: 'Supreme Leader · Malos · High Cantor' },
...
const th: typeof en = {
  ...
  perEntry: {
    ...
    'i-missing-chord': { subtitle: 'ภาพยนตร์ภาค I ของ RESONANCE Saga', role: 'Creator · Co-Director · Lead (Captain EO)', highlight: 'กำกับหนังเรื่องแรก · จุดกำเนิดของ saga · วางโครงเป็น ACT 0–III' },
    ...
    'canon': { subtitle: 'เอกสารอ้างอิงจักรวาล RESONANCE', role: 'เอกสารสร้างโลกของเรื่อง', highlight: 'ทีม Starwave · จักรวาล Melodia · ประวัติตัวละคร · ปูมหลังของจักรวาล' },
  } as Record<string, { subtitle: string; role: string; highlight: string }>,
  creativeRoles: [
    { role: 'ผู้สร้าง', detail: 'คิดจักรวาล Melodia และตัวละครหลักทั้งหมดขึ้นมาเอง' },
    { role: 'โชว์รันเนอร์', detail: 'คุมห้องเขียนบทของซีรีส์ Disney+' },
    { role: 'ผู้กำกับร่วม', detail: 'กำกับร่วมภาพยนตร์ทั้งสามภาค' },
    { role: 'นักแสดงนำ', detail: 'รับบท Captain EO ทั้งในซีรีส์และภาพยนตร์' },
    { role: 'ผู้ประพันธ์ดนตรี', detail: 'แต่งดนตรีและสกอร์ทั้งหมดเอง' },
  ],
  universeRows: [
    { item: 'ฉาก', val: 'ระหว่างกาแล็กซี · จักรวาล Melodia' },
    { item: 'ทีม', val: 'Starwave Crew (5 คน)' },
    { item: 'ตัวร้าย', val: 'Supreme Leader · Malos · High Cantor' },
    { item: 'ธีม', val: 'ดนตรี, ตัวตน, ความกลมกลืนของจักรวาล' },
    { item: 'ผู้ถือสิทธิ์ IP', val: 'The Walt Disney Company · Lucasfilm · MJ Estate · JH Company' },
    { item: 'โครงสร้างสิทธิ์', val: 'Disney (ถือส่วนใหญ่และจัดจำหน่าย) · Lucasfilm (มรดกของ Captain EO เดิม) · MJ Estate (เพลงและภาพลักษณ์ของ MJ) · JH Company (ความเป็นเจ้าของงานสร้างสรรค์และจักรวาลใหม่)' },
    { item: 'ทำไมดีลถึงปิดได้', val: 'ทุกฝ่ายมีเหตุผลของตัวเองที่จะตกลง MJ Estate เชื่อใจว่า James ซึ่งสืบสาย MJ มาชัดเจนทั้งเสียง การเต้น และงานโปรดักชัน จะให้เกียรติมรดกนี้ ไม่ใช่มาหากิน บนเงื่อนไขส่วนแบ่งที่ดีและกรอบคุมการใช้ภาพลักษณ์ที่เข้มงวด เท่ากับปลุก IP ที่หลับอยู่ขึ้นมาอย่างเคารพ · Lucasfilm ที่แฟรนไชส์หลักกำลังล้า ได้หนังเรือธงเรื่องใหม่ความเสี่ยงต่ำที่ไม่ต้องคิดขึ้นเอง · Disney ที่หนุน James อยู่แล้วหลัง Shang-Chi เก็บสิทธิ์ส่วนใหญ่กับการจัดจำหน่ายไว้ ขณะที่ James แบกความเสี่ยงด้านงานสร้างสรรค์ · ส่วน JH Company ลงทุนพัฒนาแล้วได้หุ้นความเป็นเจ้าของงานสร้างสรรค์ส่วนน้อยเป็นการแลก' },
    { item: 'เครื่องเล่นในสวนสนุก', val: 'เครื่องเล่นแบบ dark ride ของ Captain EO: RESONANCE ประกาศไว้สำหรับสวนสนุก Disney ในปี 2028 และกำหนดเปิดปี 2029 เป็นครั้งแรกที่แฟรนไชส์นี้ข้ามจากจอไปเป็นของจริงที่คนเข้าไปเล่นได้ สะท้อนที่ทางของเครื่องเล่น Captain EO ต้นฉบับปี 1986 ในประวัติศาสตร์สวนสนุก' },
  ],
  related: [
