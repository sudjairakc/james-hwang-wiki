...
const th: typeof en = {
  ...
  pictorials: [
    ...
    { year: '2025', pub: 'Dazed Korea', issue: 'March 2025', concept: 'สเปเชียลฉลอง Grammy winner — ชุดทางการทรง deconstructed, ฉากสไตล์อุตสาหกรรม ถ่ายในสัปดาห์ถัดจากพิธี Grammy', cover: false },
  ...
  socialEvolution: [
    ...
    },
    {
      ...
      color: '#facc15',
      detail: 'หลังได้ Grammy ในเดือนกุมภาพันธ์ 2025 — ความถี่ในการ post เริ่มลดลงเรื่อยๆ caption สั้นลง, Stories หายไปแทบหมด, engagement กับ fan comments ลดเหลือศูนย์ ทีม JH Company อธิบายว่าเป็น "repositioning" ไม่ใช่ "withdrawal" ในช่วงเดียวกัน official releases และ US press appearances เริ่มใช้ "James Hwang" เป็นชื่อหลักแทน GONUNMA — สะท้อนการ consolidate สู่ชื่อเดียวสำหรับตลาด global',
    },
    {
