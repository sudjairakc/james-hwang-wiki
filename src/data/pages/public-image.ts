...
const en = {
  ...
  controversies: [
    ...
    },
    {
      ...
      note: 'Surfaced during SOUR | HONEY promotion, sparking age-gap debate within the fandom — unconfirmed.',
    },
  ] as Controversy[],
  pictorials: [
    ...
    { year: '2025', pub: 'Harper\'s Bazaar Korea', issue: 'January 2025', concept: 'SOUR|HONEY pre-release — dual concept shoot mirroring the album\'s two-register visual language. Two separate 8-page spreads: one cold-tone, one warm-tone.', cover: true },
...
const th: typeof en = {
  ...
  controversies: [
    ...
    },
    {
      ...
      severity: 'low',
      names: ['Hanni (NewJeans)'],
      note: 'ช่วง SOUR | HONEY promotion ก่อให้เกิดข้อถกเถียงเรื่องช่วงอายุในแฟนด้อม ไม่มีหลักฐานยืนยัน',
    },
  ] as Controversy[],
  pictorials: [
    ...
    { year: '2025', pub: 'Harper\'s Bazaar Korea', issue: 'January 2025', concept: 'ก่อนปล่อย SOUR|HONEY — ถ่ายสอง concept สะท้อนภาษาภาพสองโทนของอัลบั้ม สเปรด 8 หน้าสองชุดแยกกัน: โทนเย็นหนึ่งชุด โทนอุ่นหนึ่งชุด', cover: true },
