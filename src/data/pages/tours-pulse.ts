...
const th: typeof en = {
  ui: {
    ...
    consensusText:
      'PULSE Tour ถูกยกเป็นเอกฉันท์ว่าเป็นโชว์สดสาย K-pop ที่ดีที่สุดของปี 2023–2024 จุดที่นักวิจารณ์พูดถึงมากที่สุดคือภาพบนเวที คุณภาพการแสดงที่ใช้ร่างกายหนัก และเซ็ตลิสต์ที่เป็นเนื้อเดียวกันทั้งสองเวอร์ชัน',
  ...
  setlistText: [
    {
      ...
      actSubtitles: [
        'เปิดด้วยความมั่นใจเต็มร้อย เป็นศิลปินที่รู้ว่าตัวเองเป็นใคร',
    ...
    },
    {
      ...
      actSubtitles: [
        'เปิดด้วยความมั่นใจเต็มร้อย แต่คราวนี้ดุกว่าขาแรก',
        ...
        'ตัดดับมืดสนิท คนดูตะโกนเรียกให้ออกมาอีก',
        'Encore — emotional resolution',
      ],
    },
  ],
    ...
    blocks: [
      {
        ...
        body: [
          'ชื่อทัวร์มาก่อนอัลบั้ม James บอกว่าคำว่า PULSE อยู่บนไวต์บอร์ดของอพาร์ตเมนต์ฮันนัมดงเกือบตลอดปี 2022 — ชีพจรในฐานะหน่วยเล็กที่สุดของการแสดงสด และเป็นสิ่งที่คนดูกับคนแสดงแบ่งกันโดยไม่ได้ตั้งใจเมื่ออยู่ในห้องเดียวกัน ทุกช่วงในเซ็ตlist ตั้งชื่อจากคลังคำชุดนั้น — IGNITION, PULL, TENDER, DRIFT และในขาปี 2024 มี FLUTTER, SELFISH DROP, REVIVE, ADRENALINE ปิดที่ AFTERGLOW',
      ...
      },
      {
        ...
        body: [
          'เซ็ตลิสต์มีอยู่ก่อนอัลบั้มจะเสร็จ ระหว่างการรื้อโครงเดือนกุมภาพันธ์ถึงพฤษภาคม 2023 James ร่างลำดับเพลงสมมุติ 20 เพลงขึ้นมาแล้วตัดอัลบั้มให้ป้อนลำดับนั้น ซึ่งเป็นเหตุผลว่าทำไม PULSE ถึงมีไตเติลสองเพลง และทำไมลำดับอัลบั้มกับเซ็ตลิสต์ ขาแรกถึงเปิดเหมือนกัน',
          'ขาแรกเล่น 23 เพลงจาก PULSE, SOFTEST TOUCH และ LIKE I DO บวก IF I KNEW ในฐานะเพลงพรีรีลีส ARE U STILL ออกเมื่อ 08/01/2024 ห้าวันก่อนเปิดขาสองที่กัวลาลัมเปอร์ เซ็ตลิสต์จึงถูกรื้อใหม่เป็น 33 เพลงภายในช่วงซ้อมสิบวันเดียว ส่วน SELFISH ถูกกันออกจากลำดับที่ประกาศทั้งหมดแล้วดรอปสดแบบไม่บอกล่วงหน้า — เป็นเพลงเดียวในทั้งสองขาที่ไม่เคยอยู่บน setlist ที่พิมพ์ออกมา',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'การรื้อเซ็ตลิสต์ขาสองถูกอัดลงในช่วง 02/01 – 11/01/2024 ที่ CJ Rehearsal Studio เดินคู่ไปกับรอบโปรโมต ARE U STILL ในคอมเพล็กซ์เดียวกัน',
        ],
      },
    ],
  },
