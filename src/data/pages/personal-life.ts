...
const th: typeof en = {
  ...
  friends: [
    {
      group: 'SOPA (School of Performing Arts Seoul)',
      note: 'กลุ่มเพื่อนสนิทที่สุดในชีวิต มาจากช่วงเรียน ม.4–ม.6 ด้วยกัน หลายคนอยู่ในวงการบันเทิงเกาหลีคนละตำแหน่ง ผ่านช่วงที่ยากที่สุดของชีวิตเทรนนีมาด้วยกัน และยังเป็นวงเพื่อนหลักของเขาจนถึงวันนี้',
      names: [],
    },
    {
    ...
    {
      group: 'NCT 127 — Lee Taeyong',
      note: 'คนละแบบกับวงในสุด — เป็นมืออาชีพและอบอุ่นจริงใจ แต่ไม่ถึงขั้นเพื่อนสนิท สองคนนี้รู้จักกันนานที่สุดในไลน์อัป เคยจับคู่กันในโชว์เคสทดสอบเคมีก่อนเดบิวต์ปี 2014 และ Taeyong คือคนเดียวในวงที่ออกมาพูดต่อสาธารณะช่วงข้อพิพาทสัญญาปี 2023 สิ่งที่ผ่านมาด้วยกันออกมาในรูปของความเคารพและการอยู่เคียงข้างในจังหวะสำคัญ ไม่ใช่ความสนิทแบบเจอกันทุกวันอย่างที่เขามีกับ Mark, Jungwoo และ Haechan',
      names: ['Lee Taeyong (1995)'],
    },
    {
