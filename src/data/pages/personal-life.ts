...
const en = {
  ...
  relationships: [
    ...
    },
    {
      ...
      type: 'rumor',
      name: 'Ashley Liao',
      detail: 'Relationship rumors originating from the Shang-Chi set, unconfirmed at the time. Later revealed to have been the start of an actual relationship.',
    },
    {
      period: '2024–2025',
      type: 'private',
    ...
    },
    {
      ...
      type: 'confirmed',
      name: 'Ashley Liao',
      detail: 'Announced via a joint statement from both parties, the same month Shang-Chi and the Legion Accursed was released in theaters. Most fans responded positively, as it was a relationship that had shown signs for a long time.',
    },
  ] as RelEntry[],
  friends: [
    {
...
const th: typeof en = {
  ...
  relationships: [
    ...
    },
    {
      ...
      type: 'rumor',
      name: 'Ashley Liao',
      detail: 'ข่าวลือเรื่องความสัมพันธ์จากกองถ่าย Shang-Chi ไม่มีการยืนยัน ณ เวลานั้น ต่อมาเปิดเผยว่าเป็นการเริ่มต้นของความสัมพันธ์จริง',
    },
    {
      period: '2024–2025',
      type: 'private',
    ...
    },
    {
      ...
      type: 'confirmed',
      name: 'Ashley Liao',
      detail: 'ประกาศผ่าน joint statement พร้อมกันทั้งสองฝ่าย หลังจาก Shang-Chi and the Legion Accursed เข้าฉายในเดือนเดียวกัน แฟนคลับส่วนใหญ่ตอบรับเชิงบวก เนื่องจากเป็นความสัมพันธ์ที่มีสัญญาณมายาวนาน',
    },
  ] as RelEntry[],
  friends: [
    {
