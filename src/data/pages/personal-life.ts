...
const th: typeof en = {
  ui: {
    ...
    seoulParagraphHtml:
      'บ้านหรูใจกลางเมืองย่าน Gangnam — <strong style="color:var(--text)">บ้าน 1 หลัง · รถส่วนตัว 1 คัน</strong> ภาษีทรัพย์สินและภาษีความมั่งคั่งของเกาหลีสูงมาก การถือสินทรัพย์ส่วนตัวหลายชิ้นจึงไม่คุ้ม ส่วนรถของบริษัท (รถตู้ รถทีมงาน) ดูแลแยกภายใต้ JH Company',
  ...
  relationships: [
    ...
    },
    {
      ...
      type: 'private',
      name: 'Karina (aespa)',
      detail: 'แหล่งข่าวใกล้ชิดบอกว่าคบกันจริงช่วงสั้นๆ ทั้งสองฝ่ายและทีมงาน SM ปิดข่าวกันอย่างเป็นระบบ ไม่มีการยืนยันอย่างเป็นทางการ ข่าวลือที่หลุดออกมาถูกปัดด้วยเหตุผลว่า "อยู่ค่ายเดียวกัน" เหมือนกรณี Winter ปี 2021',
    },
    {
      period: 'ปลายปี 2025',
      type: 'rumor',
    ...
    },
    {
      ...
      type: 'private',
      name: 'Hanni (NewJeans)',
      detail: 'แหล่งข่าวใกล้ชิดบอกว่าคบกันช่วงสั้นๆ ในช่วงนี้ ทั้งสองฝ่ายเลือกไม่เปิดเผย ข่าวที่โผล่บนโซเชียลช่วง CAN\'T LEAVE ALONE (2025) ถูกอธิบายว่าเป็นแค่การกดไลก์กดตอบกันตามปกติ แต่คนในวงการมองว่าเป็นคำอธิบายบังหน้า',
    },
    {
      period: '2024',
      type: 'rumor',
    ...
    },
    {
      ...
      type: 'confirmed',
      name: 'Ashley Liao',
      detail: 'ประกาศพร้อมกันทั้งสองฝ่ายผ่านแถลงการณ์ร่วม หลัง Shang-Chi and the Last of the Ten Rings เข้าฉายในเดือนเดียวกัน แฟนส่วนใหญ่ตอบรับดี เพราะมีสัญญาณให้เห็นมานานแล้ว',
    },
  ] as RelEntry[],
  friends: [
    {
      group: 'SOPA (School of Performing Arts Seoul)',
      note: 'กลุ่มเพื่อนสนิทที่สุดในชีวิต มาจากช่วงเรียน ม.4–ม.6 ด้วยกัน หลายคนอยู่ในวงการบันเทิงเกาหลีคนละตำแหน่ง ความสัมพันธ์ชุดนี้ผ่านช่วงที่ยากที่สุดของชีวิตเทรนนีมาด้วยกัน และยังเป็นวงเพื่อนหลักของเขาจนถึงวันนี้',
      names: [],
    },
    {
    ...
    {
      group: 'NCT 127 — Lee Taeyong',
      note: 'เป็นความสัมพันธ์อีกแบบ ไม่เหมือนวงในสุดข้างบน คือเป็นมืออาชีพและอบอุ่นจริงใจ แต่ไม่ถึงขั้นเพื่อนสนิท สองคนนี้รู้จักกันนานที่สุดในไลน์อัป เคยจับคู่กันในโชว์เคสทดสอบเคมีก่อนเดบิวต์ปี 2014 และ Taeyong คือคนเดียวในวงที่ออกมาพูดต่อสาธารณะช่วงข้อพิพาทสัญญาปี 2023 อะไรที่ผ่านมาด้วยกันออกมาในรูปของความเคารพและการอยู่เคียงข้างในจังหวะสำคัญ มากกว่าความสนิทแบบเจอกันทุกวันที่เขามีกับ Mark, Jungwoo และ Haechan',
      names: ['Lee Taeyong (1995)'],
    },
    {
  ...
  hobbies: [
    {
      ...
      detail: 'ขึ้นขนส่งสาธารณะเป็นปกติแม้จะดังระดับ A-list ทั้งรถไฟ รถเมล์ และรถไฟฟ้าใต้ดิน ทั้งในโซลและกรุงเทพฯ สมัยที่ยังกลับไทย ทีมงานรู้กันว่าเขาไม่แตะเครื่องบินเช่าเหมาลำเลย ไม่ว่าจะทัวร์หรือเดินสายโปรโมต เขาพูดเรื่องนี้ช่วงปี 2022–2023 ว่าเป็นเพราะเรื่อง carbon footprint และสภาพภูมิอากาศ จึงใช้เที่ยวบินพาณิชย์เสมอ แม้แต่ทัวร์ที่ต้องบินกว่า 30 เที่ยว',
    },
    {
      category: 'ออกกำลังกายและการเคลื่อนไหวร่างกาย',
      detail: 'ออกกำลังกายทุกวัน มีทั้งเวทเทรนนิ่ง functional fitness และ tricking ที่ฝึกมาตั้งแต่เด็ก รูปร่างที่เปลี่ยนไปชัดเจนระหว่างยุค LIKE I DO กับ PULSE ถูกมองว่าเป็นผลจากตารางฝึกที่หนักขึ้น',
    },
    {
      category: 'ทำอาหาร',
      detail: 'ทำอาหารกินเองที่บ้านสม่ำเสมอ พูดในหลายบทสัมภาษณ์ว่าเป็นวิธีคลายความกดดันหลังทัวร์หรือลงกอง เมนูที่พูดถึงบ่อยคืออาหารไทย อาหารเกาหลีแบบบ้านๆ และพาสต้า',
    },
    {
      category: 'งานบ้านและกิจวัตรในบ้าน',
      detail: 'พูดถึงงานบ้านในแง่ดีหลายครั้ง รวมถึงใน You Quiz on the Block (2022) ที่บอกว่าการทำความสะอาดช่วยให้หัวโล่ง เขาอยู่คนเดียวและไม่มีทีมงานมาจัดการงานบ้านให้',
    },
    {
      category: 'การบำบัดและสุขภาพจิต',
      detail: 'คนใกล้ตัวยอมรับกันว่า James เป็นคนเสพติดการทำงาน ตั้งแต่ปี 2023 เขาเข้าพบนักบำบัดสม่ำเสมอ ส่วนหนึ่งมาจากการออกจาก SM ความเครียดตอนตั้งบริษัท และนิสัยรับงานพร้อมกันเกินตัว เขาพูดถึงเรื่องนี้อ้อมๆ ใน Esquire Korea (2026) ว่า "มีคนช่วยให้ผมรู้ว่าเมื่อไหร่ถึงจะเรียกว่าพอ ผมไม่เคยรู้เรื่องนั้นมาก่อน" เขาไม่เคยประกาศเรื่องนี้อย่างเป็นทางการ แต่ก็ไม่ปฏิเสธเวลาถูกถาม',
    },
    {
      category: 'การเขียน',
      detail: 'เขียนเนื้อเพลงและ treatment ให้งานของตัวเองมาตั้งแต่ยุค PULSE เครดิตงานเขียนเพิ่มขึ้นเรื่อยๆ ตั้งแต่ CAN\'T LEAVE ALONE มาจนถึง Shang-Chi และ DECADE ทุกวันนี้เขามีเครดิตร่วมเขียนบทในไตรภาค MCU แล้ว',
    },
  ] as Hobby[],
  values: [
    {
      ...
      stance: 'vocal',
      detail: 'จุดยืนหลักที่เขายืนมาตลอดอาชีพ: ไม่เอาการแก้ปัญหาด้วยกำลังทหารในทุกกรณี ไม่ว่าคู่ขัดแย้งจะเป็นใคร และเรียกร้องให้เจรจากันเสมอ จุดยืนนี้คือต้นเหตุที่ทำให้เขาชนกับกระแสชาตินิยมไทยในปี 2025 และสร้างแรงเสียดทานกับสัญญาฝั่งฮอลลีวูดเป็นระยะ',
    },
    {
      topic: 'สงครามยูเครน–รัสเซีย',
      stance: 'vocal',
      detail: 'ออกแถลงการณ์เรียกร้องให้หยุดยิงทันทีในปี 2022 ตอนที่ยังอยู่ SM เป็นไม่กี่ครั้งที่เขาพูดเรื่องการเมืองนอกประเทศไทยในยุคนั้น ถ้อยคำระวังตัวและไม่ชี้ว่าใครเป็นฝ่ายรุกราน แต่ชัดเจนว่าไม่เอาสงคราม หลังออกจาก SM ในปี 2023 เขาพูดตรงขึ้น รวมถึงประณามการโจมตีพลเรือน',
    },
    {
      topic: 'อิสราเอล–กาซา / การเกี่ยวข้องทางทหารของสหรัฐฯ',
      stance: 'vocal',
      detail: 'เป็นจุดยืนที่เสี่ยงต่ออาชีพเขามากที่สุด เขาออกแถลงการณ์เรียกร้องให้หยุดยิงและเปิดทางให้ความช่วยเหลือด้านมนุษยธรรมตั้งแต่ปลายปี 2023 พร้อมประณามการสูญเสียชีวิตพลเรือนทั้งสองฝ่าย ถ้อยคำไม่ใช้คำว่า "genocide" และไม่เลือกข้างการเมืองฝ่ายใด แต่วิจารณ์การสนับสนุนทางทหารของสหรัฐฯ อย่างเปิดเผย เรื่องนี้ทำให้เกิดความตึงเครียดกับ Disney/Marvel ที่มีนโยบายเลี่ยงจุดยืนการเมืองของนักแสดง และมีรายงานว่า JH Company ต้องคุยกับทีมกฎหมายของ Marvel อย่างน้อยหนึ่งครั้ง',
    },
    {
      topic: 'ความขัดแย้งสหรัฐฯ–อิหร่าน',
      stance: 'vocal',
      detail: 'ตอนสถานการณ์ระหว่างสหรัฐฯ กับอิหร่านตึงขึ้น เขาออกแถลงการณ์เรียกร้องให้ลดระดับความขัดแย้ง ย้ำว่าการใช้กำลังทหารไม่ใช่คำตอบ ครั้งนี้เขาพูดตอนที่ย้ายไปอยู่สหรัฐฯ แล้ว จึงถูกคนอเมริกันบางกลุ่มด่าว่า "ไม่รู้จักบุญคุณประเทศที่ให้โอกาสเขา"',
    },
    {
      topic: 'Black Lives Matter',
      stance: 'vocal',
      detail: 'สนับสนุน BLM อย่างเปิดเผยตั้งแต่ปี 2020 เป็นศิลปิน K-pop กลุ่มแรกๆ ที่ออกแถลงการณ์ด้วยคำพูดของตัวเอง ไม่ใช่แค่แชร์ต่อ ต่อมาเรื่องนี้กลายเป็นสายสัมพันธ์กับฐานแฟนชาวแอฟริกัน-อเมริกันของเขา',
    },
    {
      topic: 'Asian Lives Matter',
      stance: 'vocal',
      detail: 'ตอบโต้กระแสเกลียดชังคนเอเชียในปี 2021 ตรงๆ ทั้งด้วยแถลงการณ์และการบริจาค พูดในฐานะคนเอเชียที่ต้องอยู่ในสหรัฐฯ ช่วงเดินสายโปรโมต',
    },
    {
      topic: 'ประชาธิปไตยไทย',
      stance: 'vocal',
      detail: 'สนับสนุนการเคลื่อนไหวประชาธิปไตยในไทย มีบันทึกการบริจาคแบบเปิดเผยให้กลุ่มเยาวชนไทยช่วงปี 2020–2021 เคยบอกว่า "แนวคิดใกล้กับพรรคเพื่อไทย" แต่ไม่เคยประกาศหนุนพรรคใดตรงๆ',
    },
    {
      topic: 'นโยบายจีนเดียว',
      stance: 'silent',
      detail: 'ไม่เคยพูดเรื่องไต้หวัน ทิเบต หรือฮ่องกงต่อสาธารณะเลย เป็นความเงียบที่ตั้งใจ ซึ่งนักวิจารณ์โยงกับสัญญา MCU และตลาดจีน แฟนบางส่วนมองว่าเขาเลือกความอยู่รอดมาก่อนความสม่ำเสมอในจุดยืน',
    },
  ] as ValueItem[],
  incidents: [
    {
      ...
      severity: 'low',
      body: 'ทันทีที่ PULSE World Tour จบลงในเดือนพฤษภาคม 2024 หลังลากยาวเกือบปีเต็ม (28 กรกฎาคม 2023 – 30 พฤษภาคม 2024) James โพสต์ข้อความใน Weverse ว่าเขา "เหนื่อยล้าอย่างที่สุดจากการเดินทางและการแสดงที่ไม่หยุด" และจะ "ใช้เวลาพักให้ตัวเองก่อน 1 เดือน" ก่อนเข้ากอง Shang-Chi 2 ในเดือนกรกฎาคม 2024 แฟนอ่านแล้วเป็นห่วง แต่ก็โล่งใจที่เขาพูดตรงๆ เรื่องสภาพร่างกายและจิตใจ ซึ่งหาได้ยากในวงการนี้ ไม่นานหลังจากนั้น แคมเปญ Grammy ของ ARE U STILL ก็เริ่ม',
    },
    {
      period: '2025',
      title: 'ผลกระทบจากความขัดแย้งไทย-กัมพูชา',
      severity: 'high',
      body: 'ตอนความตึงเครียดชายแดนไทย-กัมพูชาปะทุขึ้นในปี 2025 James ออกแถลงการณ์เรียกร้องสันติภาพและให้แก้ปัญหาด้วยการเจรจา ซึ่งสวนกับกระแสชาตินิยมไทยในตอนนั้นเต็มๆ ผลคือคนไทยจำนวนมากถล่มเขาบนโซเชียล มีทั้งการตัดแท่งไฟและเผาสินค้าของเขาเชิงสัญลักษณ์ หลังจากนั้น James หยุดกิจกรรมในไทยทุกอย่าง ไม่ทัวร์ ไม่โปรโมต ไม่พูดถึงประเทศไทยในสื่อ ฐานแฟนไทยหายไปเยอะ แต่ก็ยังใหญ่พอสำหรับป็อปสตาร์ระดับโลก',
    },
    {
      period: '2024–ปัจจุบัน',
      title: 'ความแตกแยกในแฟนด้อม NCT 127',
      severity: 'medium',
      body: 'เดือนสิงหาคม 2024 เขาไปงานแฟนมีตติ้งครบรอบ 8 ปีของวงในฐานะผู้ชม ไม่ได้ขึ้นแสดง — เป็นสัญญาณสาธารณะครั้งแรกว่าความตึงเครียดคลี่คลายลง การกลับวงจริงเกิดขึ้นเดือนธันวาคม 2024 เมื่อเขากลับมาร่วมกิจกรรมในฐานะ external artist และกลับมาเต็มรูปแบบอีกครั้งในงานครบรอบ 10 ปีปี 2026 ทั้งสองจังหวะเขย่าแฟนด้อมหนัก SM Entertainment เลือกเล่นทั้งสองทางพร้อมกัน คือดัน James กลับเข้าวงแต่ก็ปั่นความตึงเครียดรอบเรื่องนี้ไว้ด้วย ผลคือแฟนแตกเป็นสองฝ่ายเกือบครึ่งต่อครึ่ง ฝ่ายที่ยินดีที่เขากลับมา กับฝ่ายที่ไม่เอา ผลข้างเคียงคือคอนเทนต์ทุกชิ้นที่มี James ไม่ว่าจะในนามวงหรือนอกวง มียอดปฏิสัมพันธ์สูงผิดปกติทั้งบวกและลบ ทำให้เขากลายเป็น "แม่เหล็กดูดดราม่า" ที่ SM ยังแก้อย่างเป็นระบบไม่ได้',
    },
  ] as Incident[],
};
