...
const th: typeof en = {
  ui: {
    ...
    introHtml:
      'ข้อพิพาทกับ SM Entertainment เริ่มก่อตัวปลายปี 2022 ในประเด็นสิทธิ์ความคิดสร้างสรรค์และความโปร่งใสทางการเงิน และ James Hwang นำเรื่องขึ้นสู่ศาลในเดือนกุมภาพันธ์ 2023 ด้วยการยื่น injunction ต่อสัญญาผูกขาด จนจบลงด้วยการ settle ที่ยืนยันว่าเพลงทุกเพลงที่เขาเขียนเป็นทรัพย์สินทางปัญญาของเขาเอง — โดย master ของงานบันทึกเสียงยุค SM ยังอยู่กับ SM — และเปิดทางให้ก่อตั้ง <a href="%L%company" style="color:var(--gold)">JH Company</a> จากคดีข้อพิพาทส่วนตัวคดีเดียว กลายเป็นจุดเปลี่ยนที่ใหญ่กว่านั้น — ทำให้ Fair Trade Commission เปิดสอบสวน เกิด domino การเจรจาสัญญาเงียบๆ ในค่ายอื่น และมีการแก้กฎหมายที่สื่อเรียกเล่นๆ ว่า "Hwang Clause" ดู <a href="%L%timeline" style="color:var(--gold)">ไทม์ไลน์อาชีพ</a> สำหรับลำดับเหตุการณ์ฉบับเต็ม',
