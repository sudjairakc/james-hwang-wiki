...
const th: typeof en = {
  ui: {
    ...
    outcomeHeading: 'ยุติด้วยการตกลงกันทั้งสองฝ่าย',
  ...
  timeline: [
    ...
    },
    {
      ...
      label: 'Final mediation — successful',
      text: 'การไกล่เกลี่ยรอบต่อมาได้เงื่อนไขที่ทั้งสองฝ่ายเซ็นได้ เปิดทางไปสู่การตกลงกันปลายเดือนเดียวกัน',
      status: 'neutral',
    },
    {
    ...
    },
    {
      ...
      label: 'หุ้น SM ร่วง',
      text: 'ในช่วงซื้อขายหลังตกลงกันได้และหลังเทปหลุดผ่าน Dispatch หุ้น SM Entertainment (KOSDAQ: 041510) ร่วงลงชัดเจน นักลงทุนสถาบันเริ่มตั้งคำถามเรื่องธรรมาภิบาลภายในบริษัท — ทำให้เรื่องนี้ย้ายจากหน้าบันเทิงไปอยู่หน้าธุรกิจ',
      status: 'alert',
    },
    {
      period: 'พฤษภาคม 2023',
      label: 'Fair Trade Commission เปิดสอบสวน',
      text: 'คณะกรรมการการค้าที่เป็นธรรมของเกาหลี (Fair Trade Commission) เปิดการสอบสวนแนวปฏิบัติสัญญาไอดอลทั้งวงการ โดยอ้างคดีของ James Hwang เป็นจุดเริ่มต้นโดยตรง — ขยายเรื่องจากข้อพิพาทศิลปินคนเดียวเป็นการทบทวนทั้งอุตสาหกรรม',
      status: 'alert',
    },
    {
      period: 'กลางปี 2023',
    ...
    },
    {
      ...
      text: 'SM ประกาศให้ James กลับมาร่วมกิจกรรม NCT 127 ในฐานะ external artist ในทางกฎหมาย ข้อตกลงเดิมไม่ถูกแตะต้อง: ไม่มีการต่อสัญญาผูกขาด JH Company และ catalog หลังปี 2023 ยังเป็นของเขาทั้งหมด และเขาเลือกเองว่าจะร่วมวันไหนหรือผลงานไหน สองบริษัทร่วมเซ็นเอกสารสิทธิ์ฉบับแรกนับจากปี 2023 ในเดือนเมษายน 2026 เพื่อเคลียร์ solo re-recording ของ DECADE และต่อยอดกรอบเดิมในเดือนพฤษภาคม 2026 สำหรับงานครบรอบ 10 ปีของวง',
      status: 'resolved',
    },
  ],
  aftermath: [
  ...
  structure: [
    {
      ...
      text: 'James เข้าเกาหลีด้วย visa E-6 (ศิลปะและบันเทิง) ตอนเดบิวต์ เปลี่ยนเป็น F-2 (พำนักระยะยาว) ระหว่างช่วง NCT 127 และถือ F-5 (ถิ่นที่อยู่ถาวร) แล้วตอนเกิดข้อพิพาท สถานะถิ่นที่อยู่นี้เอง ไม่ใช่สัญญากับ SM ที่ทำให้เขายังอยู่และทำงานในเกาหลีได้อย่างอิสระหลังตกลงกันได้ในปี 2023',
    },
    {
      title: 'การจดทะเบียนบริษัท',
      text: 'JH Company จดทะเบียนที่ Seoul เป็น 주식회사 (jusik-hoesa บริษัทจำกัดแบบเกาหลี) กฎหมายเกาหลีให้คนต่างชาติถือครองบริษัทในประเทศได้ 100% และสถานะ F-5 ก็ตัดเงื่อนไขวีซ่านักลงทุนต่างชาติที่ปกติต้องมี James ถือหุ้นควบคุม 82%',
    },
    {
    ...
    {
      title: 'นิติบุคคลและวีซ่าฝั่งสหรัฐฯ',
      text: 'งาน MCU และ IP ของ RESONANCE (Disney / Lucasfilm) ดำเนินผ่านนิติบุคคลในสหรัฐฯ และวีซ่า O-1 ประเภทความสามารถพิเศษ การย้ายถิ่นปลายปี 2026 ย้ายที่พำนักหลัก — และศูนย์กลางธุรกิจฝั่งภาพยนตร์ — ไปอยู่ที่สหรัฐ',
    },
    {
      title: 'ถิ่นที่อยู่ทางภาษี',
      text: 'เขามีสถานะผู้เสียภาษีในเกาหลีตลอดช่วง SM และช่วงเดี่ยว — เจอภาษีความมั่งคั่งและภาษีทรัพย์สินสูงของเกาหลี จึงถือทรัพย์สินส่วนตัวไว้น้อยและไม่มีอสังหาฯ ในไทย — และย้ายไปเป็นผู้เสียภาษีในสหรัฐฯ หลังย้ายถิ่นปี 2026 ในฐานะพลเมืองไทยที่ถูกเก็บภาษีเฉพาะเงินที่นำเข้าประเทศไทย การใช้ชีวิตในต่างแดนทำให้ภาระภาษีไทยต่อเนื่องมีจำกัด',
    },
    {
      title: 'เส้นทางสู่สัญชาติสหรัฐ',
      text: 'หลังย้ายที่พำนักหลักไปสหรัฐปลายปี 2026 James ยื่นขอถิ่นที่อยู่ถาวรในปี 2027 ด้วยคำร้องประเภท EB-1 สำหรับผู้มีความสามารถพิเศษ โดยอ้าง Grammy สถานะนักแสดงนำใน MCU และสถิติกินเนสส์ เมื่อได้กรีนการ์ดแล้ว การขอสัญชาติจะอยู่ในระยะเอื้อมราวต้นทศวรรษ 2030 (หรือ 3 ปีถ้าแต่งกับพลเมืองสหรัฐ) เพราะสหรัฐอนุญาต dual nationality เขาจึงเพิ่มสัญชาติอเมริกันได้โดยไม่ต้องสละสัญชาติไทย แลกกับการถูกเก็บภาษีรายได้ทั่วโลกตลอดชีพ และไม่มีภาระทหารสหรัฐ — ไม่มีการเกณฑ์ และเขาเป็น non-resident อยู่ต่างแดนช่วงอายุ Selective Service',
    },
  ],
  related: [
    { label: 'JH Company', slug: 'company' },
